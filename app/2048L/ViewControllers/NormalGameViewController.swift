...
//  2048L
//
//  Created by John Kim on 4/21/19.
...
////////////////////////////////////////////////////////////////////////////////////////////
//
// A view controller for the normal game mode
//
////////////////////////////////////////////////////////////////////////////////////////////

class NormalGameViewController : UIViewController, GameModelProtocol {
    ...
    func setupSwipeControls() {
        let upSwipe = UISwipeGestureRecognizer(target: self, action: #selector(NormalGameViewController.upCommand(_:)))
        upSwipe.numberOfTouchesRequired = 1
        upSwipe.direction = UISwipeGestureRecognizer.Direction.up
        view.addGestureRecognizer(upSwipe)
        
        let downSwipe = UISwipeGestureRecognizer(target: self, action: #selector(NormalGameViewController.downCommand(_:)))
        downSwipe.numberOfTouchesRequired = 1
        downSwipe.direction = UISwipeGestureRecognizer.Direction.down
        view.addGestureRecognizer(downSwipe)
        
        let leftSwipe = UISwipeGestureRecognizer(target: self, action: #selector(NormalGameViewController.leftCommand(_:)))
        leftSwipe.numberOfTouchesRequired = 1
        leftSwipe.direction = UISwipeGestureRecognizer.Direction.left
        view.addGestureRecognizer(leftSwipe)
        
        let rightSwipe = UISwipeGestureRecognizer(target: self, action: #selector(NormalGameViewController.rightCommand(_:)))
    ...
    func setNormalFinishedToTrue(alert: UIAlertAction!) {
        normalFinished = true
    }
    ...
    func followUp() {
        ...
        if userWon {
            ...
            alert.addAction(UIAlertAction(title: "No", style: .cancel, handler: setNormalFinishedToTrue))
    ...
    func scoreChanged(to score: Int) {
        ...
        if score > UserDefaults.standard.integer(forKey: "normalHighscore") {
            UserDefaults.standard.set(score, forKey: "normalHighscore")
        }
    }
